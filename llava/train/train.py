    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0]:
            ...
            if self.data_args.image_aspect_ratio == 'pad':
                ...
                image = processor.preprocess(image, return_tensors='pt')['pixel_values'][0]
            # traces = copy.deepcopy([e["traces"] for e in sources])
...
def make_supervised_data_module_old(tokenizer: transformers.PreTrainedTokenizer,
                                data_args) -> Dict:
    ...
    eval_dataset = LazySupervisedDataset(tokenizer=tokenizer,
                                data_path='/home/niudt/LLaVA/process_dataset/large_scale_training/exp_ann/exp4/val-36743.json',
                                data_args=data_args)
