# this is for the exp4: OXE WITH trajectory
...
export EXP_NAME="exp5-with_traj-fine-tuning_2024-04-17"
...
srun \\
    ...
    python \${PROJ_ROOT}/llava/train/train_mem.py \\
        ...
        --version v1 \\
        --data_path "\${WORKDIR}/datasets/llarva/exp5/train-34051469.json::\${WORKDIR}/datasets/llarva/exp5/val-36743.json" \\
        ...
        --bf16 True \\
        --output_dir "\${OUTPUT_DIR}/checkpoints/lora/llava-v1.5-7b-lora_exp5_fine-tuning_April17" \\
        --num_train_epochs 1 \\
