...
if __name__ == '__main__':
    ...
    for sub_file in file_list:
        ...
        for ann in tqdm(file):
            ...
            question['value'] = pattern.sub(lambda m: f'the task is "{m.group(1)}", and the previous', question['value'])
        ...
        s = 1
        # save
        save_root = '/home/niudt/LLaVA/process_dataset/large_scale_training/exp_ann/exp4-new'
