...
if __name__ == '__main__':
    val_file = json.load(open('/home/niudt/LLaVA/process_dataset/annotations/small_mixed_val_random_action_matrix.json'))
    ...
    for i, sample in enumerate(tqdm(val_file)):
        ...
        # filter the episode
        current_episode = sample['image'].split('/')[3]
        current_episode_index = sample['image'].split('/')[4].split('_')[0]

        episode_name = current_episode + '-' + current_episode_index
